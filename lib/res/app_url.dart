...
class AppUrl {
  ...
  static var homeListUrl = 'http://findkolkata.com/api/findListingByQuery.php?q=webfams&areapardeshipura';


  // http://findkolkata.com/api/findListingByQuery.php?


  static var detailsListUrl = 'http://findkolkata.com/api/getListingById.php?';
